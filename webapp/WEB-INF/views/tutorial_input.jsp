...
<div class="ds-ui-input" data-ds-rows="2"></div></textarea>
							</div>
							<div class="tutorial-component-description">
...
<div class="ds-ui-input" data-ds-label="거래처" data-ds-rows="2"></div></textarea>
							</div>
...
const exampleData = [ 
						...
						<div class="phone2">
							<div>
								<iframe class="window2" src="component/input"></iframe>
							</div>
						</div>
					</div>
				</div>
