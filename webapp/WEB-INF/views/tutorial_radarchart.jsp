...
<div class='ds-ui-chart radar' id='radar1'
	...
	data-ds-calc-detail='mul price count' data-ds-x='company'></div></textarea>
							</div>
							<div class="tutorial-component-source">
...
const exampleData = [ 
		...
		{no : 40, company : 'D', good : 'pc', count : 9, price : 1500000, date : '2018-11-01', category : 'etc',desc : ''} ];</textarea>
							...
							<div class="tutorial-component-description">
								<p><span class="ds-tag-class">&nbsp;id</span>&#9; radar로 시작되는데 뒷부분은 다르게 해야됨 </p>
								<br/>
								<p><span class="ds-tag-value">&nbsp;data-ds-binding</span>&#9;데이터 바인딩 될 json 맵핑</p>
								<p><span class="ds-tag-value">&nbsp;data-ds-x</span>&#9;ds-standard 전의 분류할 기준</p>
								...
								<br/>
								<p>&nbsp;예시)<span class="ds-tag-class">&nbsp;ds-x&nbsp;</span>의 <span class="ds-tag-class">&nbsp;ds-standard&nbsp;</span>을 분류하여 <span class="ds-tag-class">&nbsp;ds-calc-detail&nbsp;</span>로 비교하여라</p>								
							</div>
							<h3>&nbsp;단어 변경</h3>
							<div class="tutorial-component-source">
...
<div class='ds-ui-chart radar' id='radar2' data-ds-binding='exampleData'
	...
	data-ds-x='company' data-ds-transfer-naming='option'></div></textarea>
							</div>
							<div class="tutorial-component-source">
