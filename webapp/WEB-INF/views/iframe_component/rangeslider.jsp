...
<body class="body">
	...
	<div class="App">
		<div class="contents">
		<div class="ds-ui-rangeslider" data-label='Range Slider#1' data-value='0 50 500'>
         </div>
         <div class="ds-ui-rangeslider" data-label='Range Slider#2' data-value='0 100 500' data-step='50'>
         </div>
         <div class="ds-ui-rangeslider" data-label='Range Slider#1 - 비활성화' data-value='0 50 500' data-disabled="true">
         </div>
