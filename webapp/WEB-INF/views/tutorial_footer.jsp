	 ...
	 <div class="ds-ui-footerBox">
       ...
       ds.ui.footer('.ds-ui-footerBox', {
            ...
            <div class="tutorial-component-description">
                ...
                <p><span class="ds-tag-value">&nbsp;dsColor</span>&#9;Footer 색상 지정 (미지정시 Default 색상)</p>
                <p><span class="ds-tag-value">&nbsp;dsDirection</span>&#9;Footer 수직, 수평 정렬 방향 지정 (미지정시 수직 정렬)</p>
                ...
                <p>&#8251; 데이터소스에서 항목을 직접 선택하여 데이터를 산출하고 산출될 데이터의 내용을 직접 지정할 수 있다. Value 객체는 ds-ui-footerBox 클래스의 자식 class의  개수만큼 지정할 수 있습니다.</p>
            </div>
...
<div class="tutorial-component-source">
    ...
    <div class="tutorial-component-description">
        ...
        <p>&#8251; Footer 내부 요소의 개수는 1~3개를 권장합니다.</p>
    </div>
