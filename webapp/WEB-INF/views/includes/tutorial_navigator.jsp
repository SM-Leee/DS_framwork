...
<div id="tutorial-navi">
	<ul>
		...
		<li class="">
			...
			<ul class="sub-navis">
				<li class="sub-navi"><a href="basic_guideline">시나리오1</a></li>
				<li class="sub-navi"><a href="script_guideline">시나리오2</a></li>
			</ul>
		</li>
		<li class=""><a href="tutorial_exam">
				<div class="tutorial-navi-index">
					<div class="tutorial-navi-icon">
						<i class="icon far fa-edit"></i>
					</div>
